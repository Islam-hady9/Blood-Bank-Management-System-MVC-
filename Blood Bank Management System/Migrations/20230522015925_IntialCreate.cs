        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BloodBankQuantity = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_BloodBanks_BloodBankId",
                        column: x => x.BloodBankId,
                        principalTable: "BloodBanks",
                        principalColumn: "BloodBankId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requests_BloodBanks_BloodBankId",
                        column: x => x.BloodBankId,
                        principalTable: "BloodBanks",
                        principalColumn: "BloodBankId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Requires", x => x.HospitalId);
                    table.ForeignKey(
                        name: "FK_Requires_Hospitals_HospitalId",
                        column: x => x.HospitalId,
                        principalTable: "Hospitals",
                        principalColumn: "HospitalId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Requires_Requests_RequestID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_BloodBankId",
                table: "Employees",
                column: "BloodBankId");

            migrationBuilder.CreateIndex(
                name: "IX_Requests_BloodBankId",
                table: "Requests",
                column: "BloodBankId");

            migrationBuilder.CreateIndex(
                name: "IX_Requires_RequestID",
                table: "Requires",
                column: "RequestID");
        }
